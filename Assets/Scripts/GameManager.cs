using UnityEngine;
using TMPro;                  // CHANGED from: using UnityEngine.UI;

public class GameManager : MonoBehaviour
{
    public static GameManager gm;

    [Tooltip("If not set, defaults to the GameObject tagged Player.")]
    ...
    public TextMeshProUGUI mainScoreDisplay;    // CHANGED from: public Text
    public GameObject gameOverCanvas;
    public TextMeshProUGUI gameOverScoreDisplay; // CHANGED from: public Text

    [Tooltip("Only needed when canBeatLevel = true.")]
    ...
    void Start()
    {
        ...
        if (canBeatLevel) beatLevelCanvas.SetActive(false);
    }
    ...
    {
        score += amount;
        mainScoreDisplay.text = canBeatLevel
            ? score.ToString() + " of " + beatLevelScore.ToString()
            : score.ToString();
    }
}
